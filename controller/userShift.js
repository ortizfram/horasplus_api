...
function calculateTotalHours(inTime, outTime) {
  const inDate = new Date(`1970-01-01T${inTime}:00-03:00`); // Ensure the time zone is included
  const outDate = new Date(`1970-01-01T${outTime}:00-03:00`); // Same here for outTime
